...
/**
 * Cette classe sert à représenter le contenu d'un mail HTML
 * @author :
 * @since : 07/02/14 16:48
 */
public class HtmlMailContentDTO extends AbstractMailContentDTO {

    /**
     * serialVersionUID
     */
    private static final long serialVersionUID = 9074478404169284063L;
