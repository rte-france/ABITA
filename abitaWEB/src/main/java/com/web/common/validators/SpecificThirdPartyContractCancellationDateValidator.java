...
/**
 * Valide la date de résiliation du contrat
 *
 * @author
 */
public class SpecificThirdPartyContractCancellationDateValidator implements Validator, Serializable {

  /**
   * serialVersionUID
   */
  private static final long serialVersionUID = 781724771169325962L;
  ...
  /** Le nom de l'attribut indiquant le libellé du champ */
  private static final String DEFAULT_VALIDATION_MESSAGE = "Date de résiliation de contrat postérieure à la date de sortie du logement";
  ...
  public void validate(FacesContext context, UIComponent component, Object value) {
    ...
    if (value != null) {
      ...
      if (otherDate == null) {
        ...
        if (otherInput != null) {
          // On part du principe que le champ "housing", s'il est présent, contient déjà l'id d'un logement valide
