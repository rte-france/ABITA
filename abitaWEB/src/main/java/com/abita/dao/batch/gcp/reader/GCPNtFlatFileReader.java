...
import com.abita.dao.batch.gcp.fieldsetmapper.NtReadAndSendFieldSetMapper;
...
/**
 * Classe qui permet de lire la pièce comptable NT
 */
public class GCPNtFlatFileReader extends FlatFileItemReader<BigDecimal> {
  ...
  private static final String READING_MESSAGE_ERROR = "Erreur lors de la lecture de la pièce comptable NT";

  /** LOGGER */
  private static final Logger LOGGER = LoggerFactory.getLogger(GCPNtFlatFileReader.class);
  ...
  public void afterPropertiesSet() {
    ...
    try {
      ...
      FileFilter fileFilter = new WildcardFileFilter("ABITA_NT_" + "*" + currentDate + "*");
  ...
  public void open(ExecutionContext executionContext) {
    LOGGER.info("File NT - Set Parameter Reader...");

    DefaultLineMapper<BigDecimal> lineMapper = new DefaultLineMapper<BigDecimal>();
    lineMapper.setLineTokenizer(lineTokenizer);
    lineMapper.setFieldSetMapper(new NtReadAndSendFieldSetMapper());
