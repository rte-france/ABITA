...
import com.abita.dao.batch.gcp.fieldsetmapper.YlZnReadAndSendFieldSetMapper;
...
/**
 * Classe qui permet de lire la piece comptable YL-ZN
 */
public class GCPYlZnFlatFileReader extends FlatFileItemReader<BigDecimal> {
  ...
  private static final String READING_MESSAGE_ERROR = "Erreur lors de la lecture de la pièce comptable YL-ZN";

  /** LOGGER */
  private static final Logger LOGGER = LoggerFactory.getLogger(GCPYlZnFlatFileReader.class);
  ...
  public void afterPropertiesSet() {
    ...
    try {
      ...
      FileFilter fileFilter = new WildcardFileFilter("ABITA_YL_ZN_" + "*" + currentDate + "*");
  ...
  public void open(ExecutionContext executionContext) {
    LOGGER.info("File YL-ZN - Set Parameter Reader...");

    DefaultLineMapper<BigDecimal> lineMapper = new DefaultLineMapper<BigDecimal>();
    lineMapper.setLineTokenizer(lineTokenizer);
    lineMapper.setFieldSetMapper(new YlZnReadAndSendFieldSetMapper());
