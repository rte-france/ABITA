package com.abita.dao.historytenant.entity;
...
/**
 * Entité d’historisation des occupants
 */
public class HistoryTenantEntity extends AbstractEntity {

  /** Serial ID */
  private static final long serialVersionUID = -6825543181354149271L;
