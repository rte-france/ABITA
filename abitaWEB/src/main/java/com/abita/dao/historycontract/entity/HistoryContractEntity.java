package com.abita.dao.historycontract.entity;
...
/**
 * Entité d'historisation des contrats occupants
 * @author
 *
 */
public class HistoryContractEntity extends AbstractEntity {

  /**
   * serialVersionUID
   */
  private static final long serialVersionUID = 3377321290728674262L;
  ...
  private HistoryHousingEntity housing;

  /**  Historisation d'un occupant */
  private HistoryTenantEntity tenant;
   ...
   * @return the housing
   */
  public HistoryHousingEntity getHousing() {
    return housing;
  }
   ...
   */
  public void setHousing(HistoryHousingEntity housing) {
   ...
   * @return the tenant
   */
  public HistoryTenantEntity getTenant() {
    return tenant;
  }
   ...
   */
  public void setTenant(HistoryTenantEntity tenant) {
    this.tenant = tenant;
  }
